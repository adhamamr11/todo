...
class MainProvider extends ChangeNotifier {
  int selectedIndex = 0;
  List<Widget> screens = [TasksScreen(), SettingsScreen(), EditTaskScreen()];
  ...
  void updateTask(TaskModel taskModel) async {
    taskModel.title = titleTextController.text;
    taskModel.desc = descTextController.text;
    taskModel.time = "${selectedTimePiker.hour} : ${selectedTimePiker.minute}";
    taskModel.date =
        DateUtils.dateOnly(selectedDatePiker).millisecondsSinceEpoch;
